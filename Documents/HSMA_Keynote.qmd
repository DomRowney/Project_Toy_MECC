...
## Development
- Prototype models were developed as part of a Hackday, a generic model and a smoking cessation modek
...
- People have a chance of visting services
- Services then have a chance of performing an intervention on people that visit
- Services can be MECC trained or not
...
- Also includes:
  ...
  + a decay of efficacy of the MECC training
- The model is run **twice**, simultaneously, once with MECC training and once without
...
- It can currerntly be used to show decision makers what level of interventions MECC would need to produce

. . .

- It has generated some interest from the organisations part of the regional MECC strategy group for agent based modelling 

## Next steps
- Write up a paper to deliver to the MECC group
- Add a report that outputs once the model runs
